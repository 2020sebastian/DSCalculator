...
public class simplifyLeft extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result.setText(Singleton.getStep3result());
        ...
        back.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(simplifyLeft.this, MyActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.simplify_left, menu);
        return true;
    }
