...
public class BreakDownFD extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result.setText(Singleton.getStep2result());
        ...
        back.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(BreakDownFD.this, MyActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.break_down_fd, menu);
        return true;
    }
