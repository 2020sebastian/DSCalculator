...
public class GetAllSuperKeys extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(GetAllSuperKeys.this, MyActivity.class);
        ...
        result.setText(Singleton.getSuperKeysResult());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.get_all_super_keys, menu);
        return true;
    }
