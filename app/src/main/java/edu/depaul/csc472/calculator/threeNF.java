...
public class threeNF extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result.setText(Singleton.getStep7result());
        ...
        back.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(threeNF.this, MyActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.three_n, menu);
        return true;
    }
