...
public class canonicalCover extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result.setText(Singleton.getStep6result());
        ...
        back.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(canonicalCover.this, MyActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.canonical_cover, menu);
        return true;
    }
