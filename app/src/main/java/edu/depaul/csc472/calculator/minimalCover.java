...
public class minimalCover extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result.setText(Singleton.getStep5result());
        ...
        back.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(minimalCover.this, MyActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.minimal_cover, menu);
        return true;
    }
